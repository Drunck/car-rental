<template>
    <div>
        ...
        <div class="bg-slate-800 px-4 py-24 mt-24 mb-8 space-y-16">
            <p class="text-justify text-white text-xl leading-relaxed max-w-6xl mx-auto">
                At Cars, we are passionate about helping you explore the world on your terms. With our
